...
import org.istic.taa.todoapp.web.filter.CachingHttpHeadersFilter;
import org.istic.taa.todoapp.web.filter.StaticResourcesProductionFilter;
import org.istic.taa.todoapp.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        parameters.put("instance-name", "TODOApp");
